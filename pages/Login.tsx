    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
            ...
            <div className="w-full max-w-sm bg-white p-8 rounded-xl shadow-lg border border-gray-200">
                <h2 className="text-2xl font-bold text-center text-iange-dark mb-6">Iniciar Sesión</h2>
             ...
             <p className="text-center text-sm text-gray-500 mt-8">
                ¿No tienes una cuenta? <a href="#" className="font-medium text-iange-orange hover:text-orange-500">Contacta a soporte</a>
            </p>
        </div>
    );
};
