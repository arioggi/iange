  ...
  users: [
    {
      ...
      photo: 'EP',
      name: 'Usuario Prueba',
      email: 'empresaprueba@iange.xyz',
      phone: '8187654321',
      role: ROLES.CUENTA_EMPRESA,
      password: 'hashedpassword',
      tenantId: '1',
      permissions: ROLE_DEFAULT_PERMISSIONS[ROLES.CUENTA_EMPRESA],
    },
    {
      id: 4,
      photo: 'JP',
      ...
      password: 'hashedpassword',
      tenantId: '1',
      permissions: ROLE_DEFAULT_PERMISSIONS[ROLES.ASESOR],
    },
  ] as User[],
  propietarios: [
    {
  ...
  propiedades: [
    {
      ...
      pais: 'México',
      tipo_inmueble: 'Casa',
      valor_operacion: '3500000',
      fotos: [],
      fecha_captacion: '2024-05-10T10:00:00Z',
      fecha_venta: '2024-07-20T15:00:00Z',
      compradorId: 201,
      checklist: generateChecklist(100),
      progreso: 100,
      status: 'Vendida',
      fuente_captacion: 'Recomendación',
      visitas: [],
      comisionOficina: 70000,
      comisionAsesor: 35000,
      fichaTecnicaPdf: '',
    },
    {
      id: 102,
      ...
      valor_operacion: '2200000',
      fotos: [],
      fecha_captacion: '2024-06-15T11:00:00Z',
      fecha_venta: null,
      compradorId: null,
      checklist: generateChecklist(50),
      progreso: 50,
      status: 'En Promoción',
      fuente_captacion: 'Portal Web',
      visitas: [],
      comisionOficina: 44000,
      comisionAsesor: 22000,
      fichaTecnicaPdf: '',
    },
    {
      id: 103,
      ...
      pais: 'México',
      tipo_inmueble: 'Casa',
      valor_operacion: '7800000',
      fotos: [],
      fecha_captacion: '2024-07-01T12:00:00Z',
      fecha_venta: null,
      compradorId: null,
      checklist: generateChecklist(25),
      progreso: 25,
      status: 'Validación Pendiente',
      fuente_captacion: 'Redes Sociales',
      visitas: [],
      comisionOficina: 156000,
      comisionAsesor: 78000,
      fichaTecnicaPdf: '',
    },
  ] as Propiedad[],
};
