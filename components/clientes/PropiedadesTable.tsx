...
const PropiedadesTable: React.FC<PropiedadesTableProps> = ({ propiedades, propietarios, onEdit, onDelete }) => {
    ...
    // ✅ NUEVA LÓGICA DE BADGES (Igual que en Compradores)
    const renderVerificationBadge = (propietario: Propietario) => {
        ...
        if (inePldOk && !biometriaOk) {
            return (
                <span className="text-[10px] text-orange-700 font-bold flex items-center gap-1 mt-1 bg-orange-100 px-2 py-1 rounded-md w-fit border border-orange-200" title="El propietario debe completar la selfie">
